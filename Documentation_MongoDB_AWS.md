...
- **Amazon ECS** :
  - Cluster ECS avec deux conteneurs : 0,1 USD/heure * 2 conteneurs * 720 heures = 144 USD/mois.
- **Amazon S3** :
  - Stockage de 1 To : environ 23 USD/mois.
- **Amazon CloudWatch** :
  - Surveillance de base : environ 10 USD/mois.

**Total estimé : ~177 USD/mois.**
